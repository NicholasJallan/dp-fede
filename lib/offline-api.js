...
(function () {
  ...
  // Alias rétro-compat — screen-archives.jsx et ScreenHome appellent api.archives.*
  window.api.archives = {
    list:          window.api.dives.listArchived,
    get:           window.api.dives.get,
    create:        window.api.dives.create,
    pendingDrive:  window.api.dives.pendingDrive,
    markDriveDone: window.api.dives.markDriveDone,
  };
